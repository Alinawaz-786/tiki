...
library Strings {
    ...
    struct pizzaIngredients {
        ...
        uint256 price;      //individual ingredient total price
    }
    //Owner use
    struct pizzaBuying {
        uint256 buyingId;
    ...
    //Admin use
    mapping(string => pizzaIngredients) public idToPizzaIngredients;  //Mapping on (string) name meat - cheese - toppings
    ...
    //Admin Create ingredients
     function _mintPizzaIngredients() public returns (uint256) {}
    ...
    payable
    {
        ...
        _transfer(0xf0EBDd31b3C62683f6463E67aCD14D9cE4FA4d43, 0x25eb1e647261C7DbE696536572De61b1a302a83C , _tokenId);
        address sendTo = 0x25eb1e647261C7DbE696536572De61b1a302a83C;
