...
contract TIKI is ERC20, Ownable {
    ...
    struct feesStruct{
        uint    bnbFee;
        uint    lPoolFee;
        uint    redistributionFee;
        uint    walletFee;
    }

    enum userType{ WhiteListedUser,NormalUser }

    mapping (userType => feesStruct) public feeMapping;
    ...
    constructor() public ERC20("TIKI", "TIKI") {
        ...
        //0xf0EBDd31b3C62683f6463E67aCD14D9cE4FA4d43 my
        //0x4Fc4bFeDc5c82644514fACF716C7F888a0C73cCc old
