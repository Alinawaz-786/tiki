...
contract pizzaNFTtest is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    // ingredients’ in the image files, that then become baked ingredients if baked into a 
    // pizza)
    ...
    function buyingPizza(
        ...
        idToBuyingPizza[wallet_address] = newbuyingPizza;    // plese check token in replace of  address
        return bakedTokenID;
    }
    //(testing)
