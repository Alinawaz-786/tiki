 ...
 */
abstract contract Lottery is ReentrancyGuard, ILottery, Ownable {
    using SafeERC20 for IERC20;
    ...
    modifier notContract() {
        // require(!_isContract(msg.sender), "_Contract not allowed");
    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        uint256 amountToShareToWinners = (
            ((_lotteries[_lotteryId].amountCollectedInFarm) *
        ...
        amountToWithdrawToTreasury += (_lotteries[_lotteryId]
            .amountCollectedInFarm - amountToShareToWinners);
