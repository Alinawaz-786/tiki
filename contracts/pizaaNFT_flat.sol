...
library SafeMath {
    ...
    uint256 _ingredientPrice = 0.01 eth;
    mapping(uint256 => pizza) public pizzaIngredients;
    ...
    function minteIngredient(address wallet_address, string memory tokenURI) public{
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
        require(!_exists(newItemId));
        uint256 _totalprice = _totalprice.add(_ingredientPrice);
