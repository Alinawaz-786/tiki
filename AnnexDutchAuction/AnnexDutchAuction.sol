...
import "./IAnnexStake.sol";


contract AnnexDutchAuction is Configurable, ReentrancyGuardUpgradeSafe {
...
//        uint amountReserve1;
    ...
    function create(CreateReq memory poolReq, address[] memory whitelist_) external nonReentrant {
        ...
        //current connect wallet address.
        //tx.origin also show the cureent wallet address. 
        ...
        IERC20  _token0 = IERC20(poolReq.token0);           // mean
        uint token0BalanceBefore = _token0.balanceOf(address(this)); //contract address
